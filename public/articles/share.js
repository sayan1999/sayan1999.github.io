(function () {
  ...
  fetch('../content-lab/manifest.json')
    ...
    .then(function (posts) {
      ...
      if (post) {
        const fullTitle = post.title + ' — AI System Designs';
        const desc = post.description || 'Engineering playbooks for modern AI stacks.';
        const url = 'https://sayan1999.github.io/articles/share.html?slug=' + encodeURIComponent(slug);
    ...
    .catch(function () { window.location.replace(dest); });
})();
